...
-- This is internal and only working with GHC >=9.10
rethrowIO' :: SomeException -> IO a
#if MIN_VERSION_base(4,20,0)
rethrowIO' e =
  case fromException e of
    -- Match the implementaiton of rethrowIO in base 4.21
    Just (e' :: ExceptionWithContext SomeException) -> throwIO (NoBacktrace e')
    Nothing -> throwIO e
#else
rethrowIO' = throwIO
#endif
